...
import com.seekerhut.utils.EnumAndConstData.*;

import java.util.HashMap;

public class DataGenConfig {
    private HTTPMethod method;
    private EncodeType postDataType;
    private String url;
    private int times;
    ...
    public EncodeType getPostDataType() {
        return postDataType;
    }

    public void setPostDataType(EncodeType postDataType) {
